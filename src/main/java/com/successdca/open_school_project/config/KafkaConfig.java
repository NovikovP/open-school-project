package com.successdca.open_school_project.config;


import com.successdca.open_school_project.kafka.MessageDeserializer;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, TaskDTO> consumerListenerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.successdca.open_school_project.model.dto.TaskDTO");
    ...
    private CommonErrorHandler errorHandler() {
        ...
        handler.setRetryListeners((rec, ex, deliveryAttempt) -> log.error("RetryListeners message = {}, offset = {}, deliveryAttempt = {}", ex.getMessage(), rec.offset(), deliveryAttempt));
        return handler;
    }
